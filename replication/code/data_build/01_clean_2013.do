...
* Purpose: clean the CHFS 2013 roster, household, and master files.
* Inputs: three separate 2013 supplier DTA files under data/raw/chfs.
* Outputs: one labeled 2013 household working DTA feeding manuscript Tables 1-11.
version 18.0
clear all
set more off
set maxvar 32767
...
local hh "`raw'/chfs2013_hh_20191120_version14.dta"
local ind "`raw'/chfs2013_ind_20191120_version14.dta"
local master "`raw'/chfs2013_master_202203.dta"

log using "`out'/logs/01_clean_2013.log", text replace name(w2013)
display "WAVE_BUILD_START=2013"

tempfile roster master_household

* Aggregate the complete person roster before selecting the documented head.
use "`ind'", clear
assert _N == 97906
isid hhid_2013 pline
gen byte __valid_member = !missing(hhid_2013) & !missing(pline)
bysort hhid_2013: egen int family_size = total(__valid_member)
bysort hhid_2013: egen byte head_count = total(hhead == 1)
bysort hhid_2013: egen int head_flag_missing_count = total(missing(hhead))
...
forvalues i = 1/`head_n' {
    ...
    bysort hhid_2013: egen double `target' = max(__head_value)
    drop __head_value
}
gen byte head_anomaly = head_count != 1
bysort hhid_2013: keep if _n == 1
keep hhid_2013 family_size head_count head_flag_missing_count head_* education_code health_code
isid hhid_2013
assert _N == 28141
...
* Master is already household-level in 2013.
use "`master'", clear
assert _N == 28141
isid hhid_2013
keep hhid hhid_2013 province prov_CHN city_lab hhcid rural swgt
...
* Household questionnaire is the merge master; no household is dropped.
use "`hh'", clear
assert _N == 28141
isid hhid_2013
keep hhid_2013 a2000 asset total_income d3101 d4100 d5101 d6101 ///
    h1001 h1004a01 h1004a02 g2001 g2004a01 g2004a02 ///
    h3039 a4007aa d1101 b3030_1 b3030_2 k2101 ///
    b3045_1_1_mc b3045_1_2_mc b3045_2_1_mc b3045_2_2_mc ///
    b3045_3_1_mc b3045_3_2_mc b3045_4_1_mc b3045_4_2_mc ///
    b3045_5_1_mc b3045_5_2_mc c3004_1 c3004_2 c3004_3 ///
    c7048c_1 c7048c_2 b3047_1 b3047_2 c3004b_1 c3004b_2 ///
    c3004b_3 c7048e_1 c7048e_2 k2111 ///
    h2003_1_mc h2003_6_mc h2003_8_mc

merge 1:1 hhid_2013 using `roster', generate(_merge_roster)
assert _merge_roster == 3
merge 1:1 hhid_2013 using `master_household', generate(_merge_master)
assert _merge_master == 3

clonevar hhid = hhid_2013
rename hhid_2013 source_hhid_2013
gen str10 source_hhid_2015 = ""
gen str10 source_hhid_2017 = ""
gen byte track = .
gen int year = 2013

gen double hhsize_questionnaire = a2000 if !missing(a2000) & a2000 >= 1 & a2000 == floor(a2000)
...
replace bond_participation = 1 if d4100 == 1
replace bond_participation = 0 if d4100 == 2
gen byte fund_participation = .
replace fund_participation = 1 if d5101 == 1
replace fund_participation = 0 if d5101 == 2
gen byte derivative_participation = .
replace derivative_participation = 1 if d6101 == 1
replace derivative_participation = 0 if d6101 == 2
...
rename h1004a01 gift_received_holiday_yuan
rename h1004a02 gift_received_ceremony_yuan
rename g2004a01 gift_given_holiday_yuan
rename g2004a02 gift_given_ceremony_yuan
...
gen double trust_ordinal = h3039 if inrange(h3039, 1, 5)
...
replace informal_credit_candidate = 1 if b3030_1 == 1 | b3030_2 == 1 | k2101 == 1
replace informal_credit_candidate = 0 if k2101 == 2 & informal_credit_candidate != 1
egen byte __paper_credit_mc = rowmax(b3045_1_1_mc b3045_1_2_mc b3045_2_1_mc b3045_2_2_mc b3045_3_1_mc b3045_3_2_mc b3045_4_1_mc b3045_4_2_mc b3045_5_1_mc b3045_5_2_mc)
gen byte informal_credit_paper = .
replace informal_credit_paper = 1 if __paper_credit_mc == 1 | inrange(c3004_1, 1, 5) | inrange(c3004_2, 1, 5) | inrange(c3004_3, 1, 5) | inrange(c7048c_1, 1, 5) | inrange(c7048c_2, 1, 5) | k2101 == 1
replace informal_credit_paper = 0 if k2101 == 2 & missing(informal_credit_paper)
gen byte require_interest_paper = .
replace require_interest_paper = 1 if b3047_1 == 1 | b3047_2 == 1 | c3004b_1 == 1 | c3004b_2 == 1 | c3004b_3 == 1 | c7048e_1 == 1 | c7048e_2 == 1 | k2111 == 1
replace require_interest_paper = 0 if missing(require_interest_paper) & (b3047_1 == 2 | b3047_2 == 2 | c3004b_1 == 2 | c3004b_2 == 2 | c3004b_3 == 2 | c7048e_1 == 2 | c7048e_2 == 2 | k2111 == 2)
...
drop a2000 asset total_income d3101 d4100 d5101 d6101 h3039 a4007aa d1101 b3030_1 b3030_2 k2101 h2003_1_mc h2003_6_mc h2003_8_mc _merge_roster _merge_master ///
    b3045_1_1_mc b3045_1_2_mc b3045_2_1_mc b3045_2_2_mc ///
    b3045_3_1_mc b3045_3_2_mc b3045_4_1_mc b3045_4_2_mc ///
    b3045_5_1_mc b3045_5_2_mc c3004_1 c3004_2 c3004_3 ///
    c7048c_1 c7048c_2 b3047_1 b3047_2 c3004b_1 c3004b_2 ///
...
label data "IRFA CHFS 2013 household working data"
...
assert _N == 28141
compress
save "`out'/data/intermediate/irfa_2013_household_working.dta", replace

display "WAVE_BUILD_RESULT=PASS WAVE=2013 N=" _N
display "WAVE_BUILD_2013=PASS"
log close w2013
